...
typedef MiniAODTriggerCandProducer<pat::Electron, pat::TriggerObjectStandAlone> PatLowPtElectronTriggerCandProducer;
DEFINE_FWK_MODULE(PatLowPtElectronTriggerCandProducer);
